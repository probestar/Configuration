...
import com.allstar.psutils.CinConvert;
import com.allstar.psutils.CinTracer;

public class ZKBridge implements Watcher {
	private static CinTracer _tracer = CinTracer.getInstance(ZKBridge.class);
	...
	public void create(String key, byte[] data) throws Throwable {
		...
		try {
			...
			_tracer.error("ZKBridge.create error. key: " + key + "; data: " + CinConvert.bytes2HexString(data), e);
		}
	}
